...
-- ldbanno -n VHDL -o lab3_impl1_mapvho.vho -w -neg -gui -msgset C:/Users/70735/Desktop/lab3/promote.xml lab3_impl1_map.ncd 
-- Netlist created on Wed Dec 09 21:40:57 2020
-- Netlist written on Wed Dec 09 21:41:17 2020
...
-- entity ccu20003
  ...
  begin
    inst1: CCU2D
      generic map (INIT0 => X"0000", INIT1 => X"5559", INJECT1_0 => "NO", 
                   INJECT1_1 => "NO")
      port map (CIN=>CI, A0=>A0, B0=>B0, C0=>C0, D0=>D0, A1=>A1, B1=>B1, 
                C1=>C1, D1=>D1, S0=>S0, S1=>S1, COUT=>CO1);
  end Structure;
...
-- entity ccu20011
  ...
  begin
    inst1: CCU2D
      generic map (INIT0 => X"aaaa", INIT1 => X"aa9a", INJECT1_0 => "NO", 
                   INJECT1_1 => "NO")
      port map (CIN=>CI, A0=>A0, B0=>B0, C0=>C0, D0=>D0, A1=>A1, B1=>B1, 
                C1=>C1, D1=>D1, S0=>S0, S1=>S1, COUT=>CO1);
  end Structure;
...
-- entity SLICE_22
  ...
  entity SLICE_22 is
    ...
    port (D1: in Std_logic; C1: in Std_logic; B1: in Std_logic; 
          A1: in Std_logic; A0: in Std_logic; FCI: in Std_logic; 
          F0: out Std_logic; F1: out Std_logic; FCO: out Std_logic);
  ...
  begin
    ...
    VitalBehavior : PROCESS (D1_ipd, C1_ipd, B1_ipd, A1_ipd, A0_ipd, FCI_ipd, 
      F0_out, F1_out, FCO_out)
    VARIABLE F0_zd         	: std_logic := 'X';
    VARIABLE F0_GlitchData 	: VitalGlitchDataType;
    VARIABLE F1_zd         	: std_logic := 'X';
...
-- entity SLICE_26
  ...
  begin
    ...
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    current_state_1_I_22_4_lut: lut40015
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
    current_state_1_I_10_i1: vmuxregsre0016
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    ...
    VitalBehavior : PROCESS (A1_ipd, D0_ipd, C0_ipd, B0_ipd, A0_ipd, DI0_dly, 
...
-- entity SLICE_27
  ...
  begin
    i842_3_lut_4_lut: lut40017
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    i844_3_lut_4_lut: lut40017
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
    disp_number_6_I_34_i2: vmuxregsre0016
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    disp_number_6_I_34_i1: vmuxregsre0016
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
...
-- entity SLICE_28
  ...
  begin
    ...
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    i834_3_lut_4_lut: lut40017
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
    disp_number_6_I_34_i6: vmuxregsre0016
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity SLICE_29
  ...
  begin
    i1315_3_lut_4_lut: lut40019
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    current_state_1_I_12_4_lut: lut40020
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_31
  ...
  begin
    i874_2_lut_4_lut: lut40023
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    i825_2_lut_4_lut: lut40024
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity vmuxregsre0027
  library IEEE, vital2000, MACHXO2;
  use IEEE.STD_LOGIC_1164.all;
  use vital2000.vital_timing.all;
  use MACHXO2.COMPONENTS.ALL;

  entity vmuxregsre0027 is
    port (D0: in Std_logic; D1: in Std_logic; SD: in Std_logic; 
          SP: in Std_logic; CK: in Std_logic; LSR: in Std_logic; 
          Q: out Std_logic);

    ATTRIBUTE Vital_Level0 OF vmuxregsre0027 : ENTITY IS TRUE;

  end vmuxregsre0027;

  architecture Structure of vmuxregsre0027 is
    signal Q_INT: Std_logic;
    signal D_INT: Std_logic;
    signal L_IN: Std_logic;
  begin
...
-- entity SLICE_32
  ...
  architecture Structure of SLICE_32 is
    ...
    component vmuxregsre0027
      port (D0: in Std_logic; D1: in Std_logic; SD: in Std_logic; 
            SP: in Std_logic; CK: in Std_logic; LSR: in Std_logic; 
            Q: out Std_logic);
    end component;
  begin
    i2_3_lut_rep_31: lut40025
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    i1192_2_lut_rep_26_4_lut: lut40026
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
    led_5_I_0_i5: vmuxregsre0027
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity SLICE_33
  ...
  begin
    i1069_2_lut: lut40028
      port map (A=>A1_ipd, B=>B1_ipd, C=>GNDI, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    i1790_2_lut: lut40029
      port map (A=>A0_ipd, B=>B0_ipd, C=>GNDI, D=>GNDI, Z=>F0_out);
    mode_i1: vmuxregsre0030
...
-- entity SLICE_35
  ...
  begin
    ...
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    mode_2_I_0_i2: vmuxregsre0016
      port map (D0=>M1_dly, D1=>VCCI, SD=>GNDI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    mode_2_I_0_i1: vmuxregsre0016
...
-- entity SLICE_37
  ...
  begin
    ...
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    i1357_3_lut_4_lut: lut40036
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
    seven_segment_disp_right_6_I_0_i2: vmuxregsre0016
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    seven_segment_disp_right_6_I_0_i1: vmuxregsre0016
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
...
-- entity SLICE_38
  ...
  begin
    i1764_4_lut_4_lut: lut40037
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    i1264_3_lut_4_lut: lut40038
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
    seven_segment_disp_right_6_I_0_i4: vmuxregsre0016
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    seven_segment_disp_right_6_I_0_i3: vmuxregsre0016
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
...
-- entity SLICE_39
  ...
  begin
    n2596_bdd_2_lut_3_lut_4_lut: lut40039
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    i1767_3_lut_4_lut: lut40040
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
    seven_segment_disp_right_6_I_0_i6: vmuxregsre0016
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    seven_segment_disp_right_6_I_0_i5: vmuxregsre0016
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
...
-- entity SLICE_40
  ...
  begin
    ones_place_1_bdd_4_lut: lut40041
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    i1761_2_lut_4_lut: lut40042
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
    seven_segment_disp_right_6_I_0_i7: vmuxregsre0016
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity SLICE_46
  ...
  begin
    i1_4_lut_else_1_lut: lut40052
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    i1_4_lut_then_1_lut_4_lut: lut40053
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_47
  ...
  begin
    i1_4_lut_adj_1: lut40054
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    i1776_4_lut: lut40055
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_48
  ...
  begin
    i1_2_lut_4_lut_adj_2: lut40056
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    i1_2_lut_rep_38: lut40057
      port map (A=>A0_ipd, B=>B0_ipd, C=>GNDI, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
...
-- entity SLICE_50
  ...
  begin
    i3_4_lut_rep_33: lut4
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    i1792_2_lut_2_lut_3_lut_4_lut: lut40039
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_51
  ...
  begin
    n2580_bdd_3_lut: lut40035
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    counter_seconds_main_1_bdd_4_lut_1817: lut40058
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_52
  ...
  begin
    i1_2_lut_rep_24: lut40057
      port map (A=>A1_ipd, B=>B1_ipd, C=>GNDI, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    i1_2_lut_rep_22_4_lut: lut40059
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_53
  ...
  begin
    i1279_3_lut_rep_20_4_lut: lut40060
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    ones_place_6_I_0_442_i8_2_lut: lut40057
      port map (A=>A0_ipd, B=>B0_ipd, C=>GNDI, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
...
-- entity SLICE_55
  ...
  begin
    i1_4_lut_rep_29: lut40063
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    mode_last_2_I_0_i2_2_lut: lut40018
      port map (A=>A0_ipd, B=>B0_ipd, C=>GNDI, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    mode_i2: vmuxregsre0030
...
-- entity SLICE_56
  ...
  begin
    i1_4_lut_adj_3: lut40064
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    i1187_2_lut_rep_30: lut40057
      port map (A=>A0_ipd, B=>B0_ipd, C=>GNDI, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
...
-- entity SLICE_57
  ...
  begin
    i1753_4_lut: lut40065
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    i1321_2_lut_3_lut: lut40066
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
...
-- entity SLICE_58
  ...
  begin
    i1194_2_lut: lut40067
      port map (A=>A1_ipd, B=>B1_ipd, C=>GNDI, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    i1371_3_lut_4_lut: lut40019
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_59
  ...
  begin
    key_in_c_0_bdd_4_lut: lut40068
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    column_c_bdd_4_lut: lut40069
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_60
  ...
  begin
    i1274_4_lut_4_lut: lut40070
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    i1759_2_lut_rep_36: lut40071
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_61
  ...
  begin
    i1_2_lut_rep_27_3_lut: lut40072
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    i1328_1_lut_2_lut_3_lut: lut40073
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, Z=>F0_out);
...
-- entity SLICE_64
  ...
  begin
    i44_4_lut: lut40076
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    i1_2_lut_rep_21_4_lut: lut40034
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_65
  ...
  begin
    i2_2_lut_3_lut: lut40077
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    i1_2_lut_rep_25: lut40028
      port map (A=>A0_ipd, B=>B0_ipd, C=>GNDI, D=>GNDI, Z=>F0_out);
...
-- entity SLICE_66
  ...
  begin
    i2_3_lut_rep_23_4_lut: lut40034
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    i1_2_lut_3_lut: lut40078
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
...
-- entity SLICE_69
  ...
  begin
    i1_2_lut_4_lut: lut40056
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    i1770_2_lut_2_lut: lut40079
      port map (A=>A0_ipd, B=>B0_ipd, C=>GNDI, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
...
-- entity Lab3
  ...
  begin
    SLICE_0I: SLICE_0
      port map (A0=>disp_number_6, FCI=>n2214, F0=>ones_place_6);
    SLICE_1I: SLICE_1
    ...
    SLICE_22I: SLICE_22
      port map (D1=>n2617, C1=>current_state_0, B1=>led_5_N_26, 
                A1=>counter_seconds_main_1, A0=>counter_seconds_main_0, 
    ...
    SLICE_25I: SLICE_25
      port map (D1=>cnt_1s_9, C1=>cnt_1s_23, B1=>cnt_1s_17, A1=>cnt_1s_12, 
                D0=>n16, C0=>n15, B0=>n2524, A0=>n17, DI0=>cnt_1s_23_N_203, 
                CLK=>clk_c, F0=>cnt_1s_23_N_203, Q0=>clk_1000ms, F1=>n17);
    SLICE_26I: SLICE_26
      port map (A1=>current_state_0, D0=>n14, C0=>n2621, B0=>led_5_N_26, 
                A0=>current_state_1_N_69, DI0=>current_state_1_N_68, 
                CLK=>current_state_1_N_80, F0=>current_state_1_N_68, 
                Q0=>current_state_0, F1=>n2);
    SLICE_27I: SLICE_27
      port map (D1=>current_state_0, C1=>disp_number_6_N_126, B1=>n2621, 
                A1=>led_5_N_26, D0=>current_state_0, C0=>disp_number_6_N_131, 
                B0=>n2621, A0=>led_5_N_26, DI1=>disp_number_6_N_125, 
                DI0=>disp_number_6_N_130, CLK=>led_5_N_40, 
                F0=>disp_number_6_N_130, Q0=>disp_number_0, 
                F1=>disp_number_6_N_125, Q1=>disp_number_1);
    SLICE_28I: SLICE_28
      port map (B1=>led_5_N_26, A1=>current_state_0, D0=>current_state_0, 
                C0=>disp_number_6_N_106, B0=>n2621, A0=>led_5_N_26, 
    ...
    SLICE_29I: SLICE_29
      port map (D1=>counter_seconds_main_3, C1=>counter_seconds_main_4, 
                ...
                D0=>n2617, C0=>n2111, B0=>current_state_1_N_47, 
                A0=>current_state_1_N_55, DI0=>current_state_1_N_46, 
                LSR=>n2621, CLK=>current_state_1_N_80, 
                F0=>current_state_1_N_46, Q0=>led_5_N_26, 
                F1=>current_state_1_N_47);
    SLICE_30I: SLICE_30
      port map (C1=>mode_0, B1=>mode_2, A1=>mode_1, C0=>led_5_N_26, B0=>n2621, 
                A0=>current_state_0, DI0=>led_5_N_37, CLK=>led_5_N_40, 
                F0=>led_5_N_37, Q0=>led_c_0, F1=>n2621);
    SLICE_31I: SLICE_31
      port map (D1=>current_state_0, C1=>mode_0, B1=>mode_2, A1=>mode_1, 
                D0=>current_state_0, C0=>mode_0, B0=>mode_2, A0=>mode_1, 
                DI1=>n1586, DI0=>n1540, LSR=>led_5_N_26, CLK=>led_5_N_40, 
                F0=>n1540, Q0=>led_c_1, F1=>n1586, Q1=>led_c_3);
    SLICE_32I: SLICE_32
      port map (C1=>mode_0, B1=>mode_2, A1=>mode_1, D0=>current_state_0, 
                C0=>mode_0, B0=>mode_2, A0=>mode_1, DI0=>n2612, 
                LSR=>led_5_N_26, CLK=>led_5_N_40, F0=>n2612, Q0=>led_c_4, 
                F1=>n2617);
    SLICE_33I: SLICE_33
    ...
    SLICE_36I: SLICE_36
      port map (D0=>cnt_1s_14, C0=>cnt_1s_3, B0=>cnt_1s_0, A0=>cnt_1s_7, 
                M0=>mode_2, CLK=>column_c_derived_3, F0=>n22_adj_6, 
                Q0=>mode_last_2, F1=>VCC_net);
    SLICE_37I: SLICE_37
      port map (C1=>n2609, B1=>n2691, A1=>n2626, D0=>ones_place_1, C0=>n2606, 
                B0=>n2607, A0=>ones_place_2, 
    ...
    SLICE_38I: SLICE_38
      port map (D1=>n22, C1=>ones_place_3, B1=>n27, A1=>n2610, D0=>n2691, 
                C0=>n2611, B0=>n2609, A0=>disp_number_0, 
    ...
    SLICE_39I: SLICE_39
      port map (D1=>ones_place_5, C1=>n2596, B1=>ones_place_6, 
    ...
    SLICE_40I: SLICE_40
      port map (D1=>n2609, C1=>ones_place_2, B1=>disp_number_0, 
    ...
    i1799_SLICE_41I: i1799_SLICE_41
      port map (D1=>n2617, C1=>counter_seconds_main_4, 
                B1=>counter_seconds_main_0, A1=>counter_seconds_main_1, 
                C0=>counter_seconds_main_4, B0=>counter_seconds_main_0, 
                A0=>counter_seconds_main_1, M0=>counter_seconds_main_3, 
                OFX0=>n2579);
    i1813_SLICE_42I: i1813_SLICE_42
      port map (D1=>disp_number_2, C1=>n2692, B1=>disp_number_1, 
                A1=>disp_number_4, C0=>disp_number_4, B0=>disp_number_5, 
                A0=>disp_number_6, M0=>disp_number_3, 
                OFX0=>seven_segment_disp_left_c_5);
    i1811_SLICE_43I: i1811_SLICE_43
      port map (D1=>counter_seconds_main_0, C1=>counter_seconds_main_1, 
                B1=>counter_seconds_main_3, A1=>counter_seconds_main_4, 
                C0=>counter_seconds_main_1, B0=>counter_seconds_main_3, 
                A0=>counter_seconds_main_4, M0=>counter_seconds_main_2, 
                OFX0=>current_state_1_N_55);
    i1807_SLICE_44I: i1807_SLICE_44
      port map (C1=>ones_place_2, B1=>ones_place_1, A1=>ones_place_5, 
                D0=>ones_place_2, C0=>disp_number_0, B0=>ones_place_1, 
                A0=>ones_place_5, M0=>ones_place_3, OFX0=>n22);
    SLICE_45I: SLICE_45
      port map (D1=>n2091, C1=>counter_seconds_main_4, 
                B1=>counter_seconds_main_1, A1=>counter_seconds_main_2, 
                D0=>counter_seconds_main_1, C0=>counter_seconds_main_2, 
                B0=>counter_seconds_main_0, A0=>counter_seconds_main_3, 
                F0=>n2091, F1=>n2111);
    SLICE_46I: SLICE_46
      port map (D1=>ones_place_2, C1=>ones_place_1, B1=>disp_number_0, 
                A1=>n2691, D0=>ones_place_5, C0=>n6, 
                B0=>seven_segment_disp_right_6_N_20, A0=>disp_number_0, 
                F0=>n2691, F1=>n2626);
    SLICE_47I: SLICE_47
      port map (D1=>disp_number_3, C1=>disp_number_4, B1=>n2692, 
                A1=>disp_number_2, D0=>n4_adj_4, C0=>tens_place_1_N_98_1, 
                B0=>n2613, A0=>disp_number_4, F0=>tens_place_0, 
                F1=>tens_place_1_N_98_1);
    SLICE_48I: SLICE_48
      port map (D1=>n2692, C1=>disp_number_2, B1=>disp_number_3, 
                A1=>disp_number_1, B0=>disp_number_5, A0=>disp_number_6, 
                F0=>n2692, F1=>n4_adj_4);
    SLICE_49I: SLICE_49
      port map (D1=>cnt_1s_22, C1=>n22_adj_6, B1=>n26_adj_1, A1=>cnt_1s_13, 
                D0=>cnt_1s_4, C0=>n18, B0=>n24, A0=>cnt_1s_2, F0=>n26_adj_1, 
                F1=>n2524);
    SLICE_50I: SLICE_50
      port map (D1=>disp_number_2, C1=>disp_number_3, B1=>disp_number_4, 
                A1=>disp_number_1, D0=>n2619, C0=>tens_place_1_N_98_1, 
                B0=>disp_number_5, A0=>disp_number_6, 
                F0=>seven_segment_disp_left_c_6, F1=>n2619);
    SLICE_51I: SLICE_51
      port map (C1=>counter_seconds_main_2, B1=>n2579, A1=>n2580, 
                D0=>counter_seconds_main_4, C0=>n2617, 
                B0=>counter_seconds_main_3, A0=>counter_seconds_main_1, 
                F0=>n2580, F1=>current_state_1_N_69);
    SLICE_52I: SLICE_52
      port map (B1=>ones_place_6, A1=>ones_place_4, D0=>disp_number_0, 
                C0=>ones_place_5, B0=>ones_place_3, A0=>n2610, F0=>n2608, 
                F1=>n2610);
    SLICE_53I: SLICE_53
      port map (D1=>n2691, C1=>n8, B1=>n2609, A1=>disp_number_0, 
                B0=>ones_place_2, A0=>ones_place_1, F0=>n8, F1=>n2606);
    SLICE_54I: SLICE_54
      port map (D1=>rst_c, C1=>n2_adj_2, B1=>n5, A1=>column_c, D0=>mode_2, 
                C0=>mode_0, B0=>mode_last_2, A0=>mode_last_0, F0=>n5, 
                F1=>n1815);
    SLICE_55I: SLICE_55
      port map (D1=>rst_c, C1=>n2_adj_2, B1=>n5, A1=>column_c, B0=>mode_1, 
                A0=>mode_last_1, M0=>key_in_c_2, CE=>clk_c_enable_2, 
                LSR=>column_c, CLK=>clk_c, F0=>n2_adj_2, Q0=>mode_2, 
                F1=>column_c_derived_3);
    SLICE_56I: SLICE_56
      port map (D1=>n2616, C1=>counter_seconds_main_3, 
                B1=>counter_seconds_main_4, A1=>counter_seconds_main_0, 
                B0=>counter_seconds_main_1, A0=>counter_seconds_main_2, 
                F0=>n2616, F1=>n14);
    SLICE_57I: SLICE_57
      port map (D1=>n2043, C1=>n11, B1=>counter_seconds_main_4, A1=>n2621, 
                C0=>counter_seconds_main_3, B0=>counter_seconds_main_1, 
                A0=>counter_seconds_main_2, F0=>n2043, 
                F1=>current_state_1_N_80);
    SLICE_58I: SLICE_58
      port map (B1=>counter_seconds_main_4, A1=>counter_seconds_main_3, 
                D0=>counter_seconds_main_0, C0=>n1915, 
                B0=>counter_seconds_main_1, A0=>counter_seconds_main_2, 
                F0=>n1817, F1=>n1915);
    SLICE_59I: SLICE_59
      port map (D1=>column_c, C1=>key_in_c_1, B1=>key_in_c_2, A1=>key_in_c_0, 
                D0=>key_in_c_2, C0=>key_in_c_0, B0=>key_in_c_1, A0=>column_c, 
                F0=>clk_c_enable_3, F1=>clk_c_enable_2);
    SLICE_60I: SLICE_60
      port map (D1=>led_5_N_26, C1=>mode_0, B1=>mode_2, A1=>mode_1, 
                D0=>led_5_N_26, C0=>mode_0, B0=>mode_2, A0=>mode_1, F0=>n2622, 
                F1=>led_5_N_40);
    SLICE_61I: SLICE_61
      port map (C1=>n2619, B1=>disp_number_5, A1=>disp_number_6, C0=>n2619, 
                B0=>disp_number_5, A0=>disp_number_6, 
                F0=>seven_segment_disp_left_c_1, F1=>n2613);
    SLICE_62I: SLICE_62
      port map (C1=>ones_place_1, B1=>ones_place_3, A1=>ones_place_2, 
                D0=>disp_number_0, C0=>ones_place_3, B0=>ones_place_1, 
                A0=>ones_place_2, F0=>n2596, F1=>n21);
    SLICE_63I: SLICE_63
      port map (C1=>mode_0, B1=>mode_2, A1=>mode_1, B0=>mode_1, A0=>mode_0, 
                F0=>n4, F1=>n11);
    SLICE_64I: SLICE_64
      port map (D1=>ones_place_1, C1=>ones_place_5, B1=>ones_place_2, 
                A1=>disp_number_0, D0=>disp_number_0, C0=>ones_place_5, 
                B0=>ones_place_3, A0=>n2610, F0=>n2607, F1=>n27);
    SLICE_65I: SLICE_65
      port map (C1=>ones_place_3, B1=>ones_place_1, A1=>ones_place_2, 
                B0=>ones_place_1, A0=>ones_place_2, F0=>n2611, F1=>n6);
    SLICE_66I: SLICE_66
      port map (D1=>ones_place_3, C1=>ones_place_5, B1=>ones_place_6, 
                A1=>ones_place_4, C0=>n22, B0=>ones_place_6, A0=>ones_place_4, 
                F0=>seven_segment_disp_right_6_N_20, F1=>n2609);
    SLICE_67I: SLICE_67
      port map (B1=>cnt_1s_21, A1=>cnt_1s_18, D0=>cnt_1s_8, C0=>cnt_1s_11, 
                B0=>cnt_1s_20, A0=>cnt_1s_16, F0=>n16, F1=>n15);
    SLICE_68I: SLICE_68
      port map (D1=>cnt_1s_19, C1=>cnt_1s_5, B1=>cnt_1s_10, A1=>cnt_1s_6, 
                B0=>cnt_1s_1, A0=>cnt_1s_15, F0=>n18, F1=>n24);
    SLICE_69I: SLICE_69
      port map (D1=>disp_number_4, C1=>disp_number_2, B1=>disp_number_3, 
                A1=>disp_number_1, B0=>tens_place_1_N_98_1, A0=>n2619, 
